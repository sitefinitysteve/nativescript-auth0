		...
		export module customtabs {
			export class ICustomTabsCallback {
				...
				public constructor(implementation: {
					onNavigationEvent(param0: number, param1: android.os.Bundle): void;
					extraCallback(param0: string, param1: android.os.Bundle): void;
					onMessageChannelReady(param0: android.os.Bundle): void;
					onPostMessage(param0: string, param1: android.os.Bundle): void;
					onRelationshipValidationResult(param0: number, param1: android.net.Uri, param2: boolean, param3: android.os.Bundle): void;
				});
				public constructor();
	...
	export module browser {
		export module customtabs {
			export class IPostMessageService {
				 ...
				 */
				public constructor(implementation: {
					onMessageChannelReady(param0: androidx.browser.customtabs.ICustomTabsCallback, param1: android.os.Bundle): void;
					onPostMessage(param0: androidx.browser.customtabs.ICustomTabsCallback, param1: string, param2: android.os.Bundle): void;
				});
				public constructor();
		...
		export module browseractions {
			...
			export module BrowserActionsFallbackMenuUi {
				export class BrowserActionsFallMenuUiListener {
					 ...
					 */
					public constructor(implementation: {
						onMenuShown(param0: globalAndroid.view.View): void;
					});
					public constructor();
