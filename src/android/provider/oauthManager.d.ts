...
export declare class OAuthManager {
    ...
    private assertNoError(errorValue, errorDescription);
    ...
    private addPKCEParameters(parameters, redirectUri);
    private addValidationParameters(parameters);
    private addClientParameters(parameters, redirectUri);
    private createPKCE(redirectUri);
