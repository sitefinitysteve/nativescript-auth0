...
import { Trackable } from './telemetry';
import { Credentials } from './credentials';

type DatabaseUser = (email: string, username: string | undefined, verified: boolean);
...
export abstract class Authentication implements Trackable, Loggable {
     ...
     */
    public login(username: string, password: string, realm: string, audience: string | undefined, scope: string | undefined, parameters: { [param: string]: any }): Request<Credentials, AuthenticationError>;
